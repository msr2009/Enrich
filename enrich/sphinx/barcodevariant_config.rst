...
**Required** Only one FASTQ_ file may be specified. If the file is ``'reverse'``, all reads will be reverse-complemented before barcodes are counted.
...
**Required** This config option must be present for the sequences to be treated as barcodes, even if it has no elements in it.
