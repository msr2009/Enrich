...
**Required** The *name* of this entity. This used for output directory names, and is included in every error message and log message. Names should be unique within a single analysis, but this is not enforced.
...
.. note:: **Required** for the top level entity (usually an :py:class:`~experiment.Experiment`) in each analysis.
